                ...
                <tbody>
                    <?php for ($i = 0; $i < count($data['admin']); $i++) { ?>
                        <tr>
                            ...
                            <td class="py-3">
                                <a href="" class="ms-4" data-bs-toggle="modal" data-bs-target="#ModalInfo-<?= $data['admin'][$i]['id'] ?>">
                                    <i class="fas fa-edit text-secondary" style="font-size: 1.5em"></i>
                                </a>
                                <a href="" class="ms-4" data-bs-toggle="modal" data-bs-target="#monModal-<?= $data['admin'][$i]['id'] ?>">
